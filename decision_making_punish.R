...
plot(c(1,65), c(0,1300), type = "n", main = "A: Group Contribution - punisment condition", 
...
plot(density(win.samples$BUGSoutput$sims.list$betaX), frame=FALSE, lwd=2, ylim=c(0,7),
     main="B: Mean Posterior Contribution - punishment condition", xlab = "Standardised % of National GDP held in tax havens by households", ylab = "")
...
par(mar=c(5,4,4,2) + 0.1)
plot(c(1,65), c(0,30), type = "n", main = "C: Initial Contribution - punishment condition", 
...
plot(density(CC.samples$BUGSoutput$sims.list$betaX_alpha), frame=FALSE, lwd=2, ylim=c(0,15),
     main="D: Initial Belief - punishment condition", xlab = "Standardised % of National GDP held in tax havens by households", ylab = "")
abline(v=0, lty=2) # Zero line for reference
...
plot(density(CC.samples$BUGSoutput$sims.list$betaX_omega), frame=FALSE, lwd=2, ylim=c(0,10),
     main="E: Belief Learning Weight - punishment condition", xlab = "Standardised % of National GDP held in tax havens by households", ylab = "")
abline(v=0, lty=2) # Zero line for reference
y_pos_e <- -0.05
...
plot(density(CC.samples$BUGSoutput$sims.list$betaX_rho), frame=FALSE, lwd=2, ylim=c(0,10),
     main="F: Conditional Preferences - punishment condition", xlab = "Standardised % of National GDP held in tax havens by households", ylab = "")
abline(v=0, lty=2) # Zero line for reference
y_pos_f <- -0.05
# Drawing the 95% Bayesian Credible Interval at the bottom
