...
#-------------------  Regress % of National GDP held on offshore accounts by households on belief weights and slope of prefs in CC model ---------------
...
# Graph B: Posterior of effect - % of National GDP held on offshore accounts by households and group winnings with adjusted 95% interval
par(mar=c(5,4,4,2) + 0.1)
